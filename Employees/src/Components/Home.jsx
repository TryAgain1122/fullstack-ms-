...
const Home = () => {
  ...
  const AdminRecords = () => {
    axios.get('https://employee-api-gy30.onrender.com/auth/admin_records')
    .then(result => {
  ...
  const adminCount = () => {
    axios.get('https://employee-api-gy30.onrender.com/auth/admin_count')
    .then(result => {
      if(result.data.Status) {
  ...
  const employeeCount = () => {
    axios.get('https://employee-api-gy30.onrender.com/auth/employee_count')
    .then(result => {
      if(result.data.Status) {
  ...
  const salaryCount = () => {
    axios.get('https://employee-api-gy30.onrender.com/auth/salary_count')
    .then(result => {
      if (result.data.Status) {
  ...
  const handleDelete = (id) => {
    axios.delete('https://employee-api-gy30.onrender.com/auth/delete_admin/' + id)
      .then(result => {
        if (result.data.Status) {
